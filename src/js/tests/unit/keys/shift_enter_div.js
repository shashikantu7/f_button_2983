...
document.addEventListener(
  'DOMContentLoaded',
  function () {
    QUnit.module('keys/shift_enter_div')
    ...
    const shift_enter_div_cases = {
      ...
      '<div>foo bar#</div>': 
      '<div>foo bar<br>#<br></div>',

      '<div>foo #<strong>bar</strong></div>': 
      '<div>foo <br>#<strong>bar</strong></div>',

      '<div>foo <strong>#bar</strong></div>': 
      '<div>foo <br><strong>#bar</strong></div>',

      '<div>foo <strong>b#ar</strong></div>': 
      '<div>foo <strong>b</strong><br><strong>#ar</strong></div>',

      '<div>foo <strong>bar#</strong></div>': 
      '<div>foo <strong>bar</strong><br><strong>_#</strong><br></div>',

      '<div>foo <strong>bar</strong>#</div>': 
      '<div>foo <strong>bar</strong><br>#<br></div>',

      '<div>foo <strong><em>#bar</em></strong></div>': 
      '<div>foo <br><strong><em>#bar</em></strong></div>',

      '<div>foo <strong><em>b#ar</em></strong></div>': 
      '<div>foo <strong><em>b</em></strong><br><strong><em>#ar</em></strong></div>',

      '<div>foo <strong><em>bar#</em></strong></div>': 
      '<div>foo <strong><em>bar</em></strong><br><strong><em>_#</em></strong><br></div>',
      ...
      '<div>froala<br>#<br></div><table><tbody><tr><td>foo bar</td></tr></tbody></table>',

      '<table><tbody><tr><td>foo bar</td></tr></tbody></table><div>#froala</div>': 
      '<table><tbody><tr><td>foo bar</td></tr></tbody></table><div><br>#froala</div>'
    }
    ...
    let t = 0
    for (const input in shift_enter_div_cases) {
      shift_enterTest(input, shift_enter_div_cases[input], ++t)
    }
  })